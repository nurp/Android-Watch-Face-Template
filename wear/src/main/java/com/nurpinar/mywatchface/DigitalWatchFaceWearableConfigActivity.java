...
/**
 * The watch-side config activity for {@link ExchangeWatchFaceService}, which allows for setting the
 * background color.
 */
public class DigitalWatchFaceWearableConfigActivity extends Activity implements
    ...
    private void updateConfigDataItem(final int backgroundColor) {
        ...
        configKeysToOverwrite.putInt(ExchangeWatchFaceUtil.KEY_BACKGROUND_COLOR,
                backgroundColor);
