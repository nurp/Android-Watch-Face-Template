...
/**
 * A {@link com.google.android.gms.wearable.WearableListenerService} listening for {@link ExchangeWatchFaceService} config messages
...
public class DigitalWatchFaceConfigListenerService extends WearableListenerService
    ...
    public void onMessageReceived(MessageEvent messageEvent) {
        if (!messageEvent.getPath().equals(ExchangeWatchFaceUtil.PATH_WITH_FEATURE)) {
            return;
        }
        ...
        ExchangeWatchFaceUtil.overwriteKeysInConfigDataMap(mGoogleApiClient, configKeysToOverwrite);
    }
