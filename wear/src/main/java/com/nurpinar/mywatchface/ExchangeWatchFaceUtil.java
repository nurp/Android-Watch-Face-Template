...
/**
 * Created by nurpinar on 25.4.2015.
 */

public final class ExchangeWatchFaceUtil {
    private static final String TAG = "DigitalWatchFaceUtil";

    /**
     * The {@link com.google.android.gms.wearable.DataMap} key for {@link ExchangeWatchFaceUtil} background color name.
     * The color name must be a {@link String} recognized by {@link android.graphics.Color#parseColor}.
     */
    public static final String KEY_BACKGROUND_COLOR = "BACKGROUND_COLOR";

    /**
     * The {@link com.google.android.gms.wearable.DataMap} key for {@link ExchangeWatchFaceService} hour digits color name.
     * The color name must be a {@link String} recognized by {@link android.graphics.Color#parseColor}.
     */
    public static final String KEY_HOURS_COLOR = "HOURS_COLOR";

    /**
     * The {@link com.google.android.gms.wearable.DataMap} key for {@link ExchangeWatchFaceService} minute digits color name.
     * The color name must be a {@link String} recognized by {@link android.graphics.Color#parseColor}.
     */
    public static final String KEY_MINUTES_COLOR = "MINUTES_COLOR";

    /**
     * The {@link com.google.android.gms.wearable.DataMap} key for {@link ExchangeWatchFaceService} second digits color name.
     * The color name must be a {@link String} recognized by {@link android.graphics.Color#parseColor}.
     */
    public static final String KEY_SECONDS_COLOR = "SECONDS_COLOR";

    /**
     * The path for the {@link com.google.android.gms.wearable.DataItem} containing {@link ExchangeWatchFaceService} configuration.
     */
     ...
     * color.
     */
    public static final String COLOR_NAME_DEFAULT_AND_AMBIENT_DATE_MONTH = "Gray";
    public static final int COLOR_VALUE_DEFAULT_AND_AMBIENT_DATE_MONTH =
            parseColor(COLOR_NAME_DEFAULT_AND_AMBIENT_DATE_MONTH);

    /**
     * Callback interface to perform an action with the current config {@link com.google.android.gms.wearable.DataMap} for
     * {@link ExchangeWatchFaceService}.
     */
    ...
    /**
     * Asynchronously fetches the current config {@link DataMap} for {@link ExchangeWatchFaceService}
                ...
                new ResultCallback<NodeApi.GetLocalNodeResult>() {
                    ...
                    public void onResult(NodeApi.GetLocalNodeResult getLocalNodeResult) {
                        ...
                        Uri uri = new Uri.Builder()
                                .scheme("wear")
                                .path(ExchangeWatchFaceUtil.PATH_WITH_FEATURE)
                                .authority(localNode)
                                .build();
    ...
    public static void overwriteKeysInConfigDataMap(final GoogleApiClient googleApiClient,
        ...
        ExchangeWatchFaceUtil.fetchConfigDataMap(googleApiClient,
                new FetchConfigDataMapCallback() {
                    ...
                    public void onConfigDataMapFetched(DataMap currentConfig) {
                        ...
                        ExchangeWatchFaceUtil.putConfigDataItem(googleApiClient, overwrittenConfig);
                    }
                }
        );
    }
