 ...
 */
public class ExchangeWatchFaceCompanionConfigActivity  extends Activity
        implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
        ResultCallback<DataApi.DataItemResult> {
    private static final String TAG = "ExchangeWatchFaceConfig";
     ...
     *
     * @param config the {@code ExchangeWatchFaceService} config {@link DataMap}. If null, the
